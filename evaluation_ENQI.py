...
# Evaluation results after 10 trials
# Average time steps taken: 3.3
# Average rewards obtained: 17.7
# Average number of penalties incurred: 0.0



#by adding grid 8*8:
# Average time steps taken: 3.8
# Average rewards obtained: 17.2
# Average number of penalties incurred: 0.0

# 10 by 10 grid:
# Evaluation results after 10 trials
# Average time steps taken: 3.0
# Average rewards obtained: 18.0
# Average number of penalties incurred: 0.0